// import { BBTagRuntimeError, VariableCache } from '@cluster/bbtag';
...
//                     ['A', 'B', '1', '2', 'Z'] // return A, then B, then 1, then 2
//                 ],
//                 expected: new BBTagRuntimeError('Nope'),
...
//         }, {
//             arrange(ctx, details, args) {
//                 const checkResults: void[] = [undefined];
//                 checkResults[details.maxLoops - 1] = undefined;
...
//                     .thenThrow(new BBTagRuntimeError('Nope'));
