...
//                     expect(result).satisfies(Array.isArray, 'because the result should be an array');
//                 else {
//                     if (details.args.length > 0)
//                         expect(result).to.not.have.ordered.members(details.args);
//                     expect(result).to.have.members(details.args);
//                 }
//             }
//         });
//         testExecute(subtag, [
